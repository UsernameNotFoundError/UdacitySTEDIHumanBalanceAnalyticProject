...
Stepttrainertrustedzone_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://udacity-training-ab/project/step_trainer/trusted/"],
        "recurse": True,
    },
...
MachineLearningdatacurated_node1684757979146 = glueContext.getSink(
    path="s3://udacity-training-ab/project/machine_learning/curated/",
    connection_type="s3",
...
MachineLearningdatacurated_node1684757979146.setCatalogInfo(
    catalogDatabase="ab-udacity-project", catalogTableName="machine_learning_curated"
)
